...
func (a *API) OutputModules() error {
	...
	if err != nil {
		return Error(err, LoadErrorCode, "unable to load outputmodule sql template", "dbs.outputmodules.OutputModules")
	}
	...
	if err != nil {
		return Error(err, QueryErrorCode, "unable to query output module", "dbs.outputmodules.OutputModules")
	}
	return nil
}
