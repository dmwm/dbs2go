...
ALTER TABLE MIGRATION_BLOCKS DROP CONSTRAINT MR_MB;
...
ALTER TABLE ASSOCIATED_FILES DROP CONSTRAINT TUC_AF_1;
...
ALTER TABLE DATASET_OUTPUT_MOD_CONFIGS DROP CONSTRAINT TUC_DC_1;
...
ALTER TABLE BLOCKS DROP CONSTRAINT NN_BK_ORIGIN_SITE_NAME;
...
ALTER TABLE DATASETS DROP CONSTRAINT NN_DS_DATASET_ACCESS_TYPE_ID;
...
ALTER TABLE MIGRATION_BLOCKS DROP CONSTRAINT NN_MB_MIGRATION_BLOCK_ID;

ALTER TABLE MIGRATION_BLOCKS DROP CONSTRAINT NN_MB_MIGRATION_REQUEST_ID;

ALTER TABLE MIGRATION_BLOCKS DROP CONSTRAINT PK_MB;

ALTER TABLE MIGRATION_BLOCKS DROP CONSTRAINT TUC_MB_1;
...
ALTER TABLE MIGRATION_REQUESTS DROP CONSTRAINT NN_MR_MIGRATION_REQUEST_ID;

ALTER TABLE MIGRATION_REQUESTS DROP CONSTRAINT PK_MR;

ALTER TABLE MIGRATION_REQUESTS DROP CONSTRAINT TUC_MR_1;
...
ALTER TABLE PARAMETER_SET_HASHES DROP CONSTRAINT NN_PSH_PSET_HASH;

ALTER TABLE PARAMETER_SET_HASHES DROP CONSTRAINT PK_PSH;

ALTER TABLE PARAMETER_SET_HASHES DROP CONSTRAINT TUC_PSH_PSET_HASH;
...
/* ---------------------------------------------------------------------- */
/* Drop table "DATASET_ACCESS_TYPES"                                      */
/* ---------------------------------------------------------------------- */

/* Drop constraints */

ALTER TABLE DATASET_ACCESS_TYPES DROP CONSTRAINT NN_DTP_DATASET_ACCESS_TYPE_ID;

ALTER TABLE DATASET_ACCESS_TYPES DROP CONSTRAINT NN_DTP_DATASET_ACCESS_TYPE;

ALTER TABLE DATASET_ACCESS_TYPES DROP CONSTRAINT PK_DTP;

ALTER TABLE DATASET_ACCESS_TYPES DROP CONSTRAINT TUC_DTP_DATASET_ACCESS_TYPE;
...
/* ---------------------------------------------------------------------- */
/* Drop table "FILE_DATA_TYPES"                                           */
/* ---------------------------------------------------------------------- */

/* Drop constraints */

ALTER TABLE FILE_DATA_TYPES DROP CONSTRAINT NN_FT_FILE_TYPE_ID;

ALTER TABLE FILE_DATA_TYPES DROP CONSTRAINT NN_FT_FILE_TYPE;

ALTER TABLE FILE_DATA_TYPES DROP CONSTRAINT PK_FT;

ALTER TABLE FILE_DATA_TYPES DROP CONSTRAINT TUC_FT_FILE_TYPE;
...
ALTER TABLE BRANCH_HASHES DROP CONSTRAINT NN_BH_BRANCH_HASH;
...
ALTER TABLE RELEASE_VERSIONS DROP CONSTRAINT NN_RV_RELEASE_VERSION;

ALTER TABLE RELEASE_VERSIONS DROP CONSTRAINT PK_RV;

ALTER TABLE RELEASE_VERSIONS DROP CONSTRAINT TUC_RV_RELEASE_VERSION;
